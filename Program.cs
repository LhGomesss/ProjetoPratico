...
Console.WriteLine("Se quiser encerrar a contagem de ursos, digite um número maior do que 250");
...
Console.WriteLine($"Pesos médios: \n\tMachos = {mediaPesoMachos:N1}kg\n\tFêmeas = {mediaPesoFemeas:N1}kg\n\tGeral  = {mediaPeso:N1}kg\n");
